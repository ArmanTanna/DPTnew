...
namespace SafenetIntegration
{
  public class SentinelEMSWrapper
  {
    ...
    {
      CheckAuth();
      string[] searchCustParams = new string[] { "crmId=" + customer["CrmId"].Value<string>(), "vendorId=" + VENDOR };
    ...
    {
      CheckAuth();
      string[] searchCustParams = new string[] { "crmId=" + data["CrmId"].Value<string>(), "vendorId=" + VENDOR };
