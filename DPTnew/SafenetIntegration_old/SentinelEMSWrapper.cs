...
namespace SafenetIntegration
{
  public class SentinelEMSWrapper
  {
    ...
    public void UpdateCustomer(string customerId, JObject customer)
    {
      CheckAuth();
      string customerXml = BuildCustomer(customer);
    ...
    private string BuildCustomer(JObject customer)
    {
      ...
      customerModel.defaultContact.firstName = customer["FirstName"].Value<string>();
      customerModel.defaultContact.lastName = customer["LastName"].Value<string>();
