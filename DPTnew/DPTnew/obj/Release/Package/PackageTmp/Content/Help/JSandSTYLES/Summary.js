...
//===============================================================
//Script By Nicola Binaghi, 05-June-06
//AMDGeS
//===============================================================
...
*/
function WriteMe(sPage, sCHMorDir, WindowType, Product, CHMfile, ProgressiveNumber)

{
//	window.onError=  ErrorHider;
	var bDLLOK = true; 
    if(Product == '') {
		Product = "thinkdesign";
	}
...
var ThisScriptLine01 = "function DynResizeIFrame" + ProgressiveNumber + "() {";
...
var ThisScriptLine03b = "oIFrameUFFA.style.height = oIFrameUFFA.contentWindow.document.body.scrollHeight;";
...
//
var ThisOutputLineUFFA = '<iframe id="MyIframeUFFA' + ProgressiveNumber + '" name="MyIframeUFFA' + ProgressiveNumber + '" frameborder="no" marginheight="0" marginwidth="0" style="height: 100%; width: 98%; border: none; margin: 0px;" SRC="' + ToBeOpened + '"' + ' onLoad="ResizeIFrameUFFA' + ProgressiveNumber  + '()" scrolling="no"></iframe>';
var ThisOutputLine2 = '<iframe id="MyIframe' + ProgressiveNumber + '" name="MyIframe' + ProgressiveNumber + '" frameborder="no" marginheight="0" marginwidth="0" style="height: auto; width: 98%; border: none; margin: 0px;" SRC="' + ToBeOpened + '"' + ' onLoad="DynResizeIFrame' + ProgressiveNumber  + '()"' + ' scrolling="no" ></iframe>';
//
if((ToBeOpened.match('currentstyle.htm'))||(ToBeOpened.match('general/jsoptions/Description.htm'))||(ToBeOpened.match('Font.htm'))||(ToBeOpened.match('FrameGroup.htm'))||(ToBeOpened.match('chareffects.htm'))||(ToBeOpened.match('SM_Orientation.htm'))||(ToBeOpened.match('SM_FlipSightDirection.htm'))||(ToBeOpened.match('SM_RotationAngle.htm'))||(ToBeOpened.match('HOMEOPS.htm'))||(ToBeOpened.match('T_TOC_Customize.htm'))) {
	...
	document.write(ThisOutputLine2);
		...
		if(this.location.href.match('german')) {
			alert('Installieren Sie zur Anzeige der gew・schten Hilfe-Seite zun臘hst die think3-Dokumentation und probieren es dann erneut.')
		}
		if(this.location.href.match('japanese')) {
