...
*/
function WriteMe(sPage, sCHMorDir, Product, CHMfile, ProgressiveNumber)
...
//
			...
			var ThisScriptLine02 = " var oIFrame" + ProgressiveNumber +" = this.parent.document.getElementById('MyIframe" + ProgressiveNumber + "');";
...
//
			var ThisOutputLine2 = '<iframe id="MyIframe' + ProgressiveNumber + '" name="MyIframe' + ProgressiveNumber + '" frameborder="no" marginheight="0" marginwidth="0" style="height: auto; width: 98%; border: none; margin: 0px;" SRC="' + ToBeOpened + '"' + ' onLoad="DynResizeIFrame' + ProgressiveNumber  + '()"'  + ' onResize="DynResizeIFrame' + ProgressiveNumber  + '()"' + ' onMouseOver="DynResizeIFrame' + ProgressiveNumber  + '()"' +' scrolling="no" ></iframe>';
//alert(ToBeOpened);
