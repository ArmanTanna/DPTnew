...
cp[14] = new Array("tdsuite", "1. TD Suite at a glance!", "l1c4p1", "Products", "Product Mktg", "440")
cp[15] = new Array("tddraftvstdbasevstdeng", "2. TDDrafting vs TDBase vs TDEngineering", "l1c4p2", "Products", "Product Mktg", "1130")
cp[16] = new Array("tdengvsbigbrothers", "3. TDEngineering vs Big Brothers", "l1c4p3", "Products", "Product Mktg", "1950")
cp[17] = new Array("tdengplusvstfree", "4. TDEngineeringPlus vs ThinkFree (EoL) vs TDTooling", "l1c4p4", "Products", "Product Mktg", "1140")
cp[18] = new Array("tdstylingvstdprof", "5. TDStyling vs TDProfessional", "l1c4p5", "Products", "Product Mktg", "2060")
cp[19] = new Array("tdproductsequivalence", "6. TD Products Equivalence", "l1c4p6", "Products", "Product Mktg", "1180")
cp[20] = new Array("eolmodules", "7. What about End-of-Life modules?", "l1c4p7", "Products", "Product Mktg", "1510")
cp[21] = new Array("all", "8. TD Suite in detail", "l1c4p8", "Products", "Product Mktg", "1200")
cp[22] = new Array("ttsuite", "9. TT Suite at a glance!", "l1c4p9", "Products", "Product Mktg", "1520")
cp[23] = new Array("releasenotes", "10. Release Notes", "l1c4p10", "Products", "Product Mktg", "600")
cp[24] = new Array("trycampaign", "1. Try & &hellip;", "l1c5p1", "Campaigns", "Sales & Mktg", "1160")
cp[25] = new Array("genginers", "2. Genginers", "l1c5p2", "Campaigns", "Sales & Mktg", "1250")
cp[26] = new Array("thinkcompusers", "3. ThinkCompusers", "l1c5p3", "Campaigns", "Sales & Mktg", "1610")
cp[27] = new Array("cadlabians", "4. Cadlabians", "l1c5p4", "Campaigns", "Sales & Mktg", "400")
cp[28] = new Array("thinkstart", "5. ThinkStart", "l1c5p5", "Campaigns", "Sales & Mktg", "200")
cp[29] = new Array("installtd2015", "1. The first time I install TD2015 on my PC", "l1c6p1", "Licensing 2015", "License Manager", "450")
cp[30] = new Array("generatec2v", "2. How to generate a C2V file?", "l1c6p2", "Licensing 2015", "License Manager", "250")
cp[31] = new Array("generatec2vdongle", "3. How to generate a C2V file using a dongle?", "l1c6p3", "Licensing 2015", "License Manager", "710")
cp[32] = new Array("wrongc2v", "4. Why is my C2V file wrong?", "l1c6p4", "Licensing 2015", "License Manager", "330")
cp[33] = new Array("getv2c", "5. How can I get my V2C file?", "l1c6p5", "Licensing 2015", "License Manager", "90")
cp[34] = new Array("usev2c", "6. How can I use my V2C file?", "l1c6p6", "Licensing 2015", "License Manager", "1200")
cp[35] = new Array("wrongv2c", "7. What if my V2C file is wrong?", "l1c6p7", "Licensing 2015", "License Manager", "320")
cp[36] = new Array("floatinglicenses2015", "8. How can I manage floating licenses?", "l1c6p8", "Licensing 2015", "License Manager", "1460")
cp[37] = new Array("td2015nostart", "9. TD2015 doesn&lsquo;t start, and neither does the previous version", "l1c6p9", "Licensing 2015", "License Manager", "200")
cp[38] = new Array("exportlicense2015", "10. Can I export my licence 2015?", "l1c6p10", "Licensing 2015", "License Manager", "110")
cp[39] = new Array("howtoexportlicense2015", "11. How can I export a license?", "l1c6p11", "Licensing 2015", "License Manager", "300")
cp[40] = new Array("selfserviceexport", "12. How does the self-service export functionality work?", "l1c6p12", "Licensing 2015", "License Manager", "1000")
cp[41] = new Array("dongleondifferentpc2015", "13. What if I want to use my dongle on a different PC?", "l1c6p13", "Licensing 2015", "License Manager", "120")
...
cp[44] = new Array("dongleondifferentpc2014", "3. What if I want to use my dongle on a different PC?", "l1c7p3", "Licensing 2014", "License Manager", "180")
...
cp[46] = new Array("graybuttonsinla", "5. Why do I get &lsquo;gray&lsquo; buttons in License Administrator?", "l1c7p5", "Licensing 2014", "License Manager", "90")
